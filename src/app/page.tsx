...
export default function Home() {
  return (
    <main className="flex min-h-screen lg:overflow-hidden relative bg-background text-foreground overflow-x-hidden">
      ...
      <div className="flex flex-col lg:flex-row w-full relative z-10">
        <Sidebar />
        <div className="flex-1 flex items-center justify-center p-4 lg:p-8 overflow-y-auto overflow-x-hidden min-h-[100svh] lg:min-h-0">
          <ErrorBoundary>
            <ChatCanvas />
          </ErrorBoundary>
        </div>
