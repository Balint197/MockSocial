...
export const TelegramSkin = () => {
    ...
    return (
        <div className={`flex flex-col h-full relative font-sans ${wallpaper ? 'bg-transparent' : (isDarkMode ? 'bg-[#0f0f0f]' : 'bg-[#708499]')}`}>
            ...
            {/* Messages */}
            <div data-message-export-container className="flex-1 overflow-y-auto p-3 flex flex-col gap-2 relative z-0 pb-4">
                 {/* Date Header */}
                 ...
                 {messages.map((msg) => {
                     ...
                     return (
                         <div key={msg.id} data-message-export-item className={`flex w-full ${isMe ? "justify-end" : "justify-start"} mb-1`}>
                             <div 
                                className={`
                             ...
                             >
                                 ...
                                 <div className={`absolute bottom-1 right-2 flex items-center gap-1 ${isMe ? (isDarkMode ? "text-[#8faabf]" : "text-[#59a648]") : (isDarkMode ? "text-[#5e778a]" : "text-[#aeb5bc]")}`}>
                                     ...
                                     {isMe && (
                                         ...
                                         <svg data-message-export-exclude viewBox="0 0 18 18" className="w-3.5 h-3.5 fill-current">
